...
TORRENTS_DIR = os.getenv("TORRENTS_DIR", "/path/to/your/torrent/downloads")
MOVIES_DIR = os.getenv("MOVIES_DIR", "/path/to/your/media-server/movies")
TV_SHOWS_DIR = os.getenv("TV_SHOWS_DIR", "/path/to/your/media-server/tv-shows")
